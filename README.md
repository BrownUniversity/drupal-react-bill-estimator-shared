...
```sh
// npm
npm i git+https://bitbucket.brown.edu/scm/dreact/drupal-react-bill-estimator-shared.git#semver:^1.2

// yarn
yarn add git+https://bitbucket.brown.edu/scm/dreact/drupal-react-bill-estimator-shared.git#^1.2
```
